...
intervalo_tiro_inimigo = random.randint(2,4)
# Modelos de Objetos
MeiaSeta = Polygon()
Mastro = Polygon()
...
def CriaInstancias(TipoPersonagem: int):
    ...
    if TipoPersonagem == 0:  # Jogador da MatrizExemplo0
        ...
        Personagens[i].tipo = "jogador"  # <- Tipo marcado corretamente
...
def init():
    ...
    # Define a cor do fundo da tela (DarkSlateBlu)
    glClearColor(0.419608,0.137255,0.556863,0)
